  ...
  "configurations": [
    {
      "type": "debugpy",
      "request": "launch",
      "name": "Debug Flask Web App (app.py)",
      "program": "${workspaceFolder}/${input:flaskAppPath}",
      "console": "integratedTerminal"
    },
    {
      "type": "debugpy",
      "request": "launch",
      "name": "Debug Tkinter GUI (Dla_mieszkancow.py)",
      "program": "${workspaceFolder}/PROF_INSTAL/Dla_mieszkancow.py",
      "console": "integratedTerminal"
    }
  ],
  "inputs": [
    {
      "type": "pickString",
      "id": "flaskAppPath",
      "description": "Select the Flask app to debug",
      "options": [
        "app.py",
        "PROF_INSTAL/Mieszkancy/profinstal_web/app.py"
      ]
    }
  ]
}
